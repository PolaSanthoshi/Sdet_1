...
export async function getServerSideProps(context:any){
     ...
     if(token){
          ...
          const data=await fetch('https://Before--superb-wisp-294d55.netlify.app/.netlify/functions/menu');
          const menuData= await data.json();
          const response=await fetch(`https://Before--superb-wisp-294d55.netlify.app/.netlify/functions/confirmation?id=${id}`);
