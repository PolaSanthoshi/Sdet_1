...
export async function getServerSideProps(context:any){
    ...
    const response=await fetch("https://Before--superb-wisp-294d55.netlify.app/.netlify/functions/menu")
    const val=await response.json();
    const data=await fetch(`https://Before--superb-wisp-294d55.netlify.app/.netlify/functions/totalCount`)
    const value=await data.json();    
    const fetchedVal=await fetch('https://Before--superb-wisp-294d55.netlify.app/.netlify/functions/storedMenu');
