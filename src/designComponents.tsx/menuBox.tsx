...
export default function MenuBox(props: { menuItems: string[]; backgroundColor: string }) {
  ...
  return <div className="flex justify-center items-center ">
    ...
    <div className="absolute p-1 text-sm font-semibold -top-3 right-3 rounded-md bg-yellow-400">Today Menu</div>
    {/* <img src='/images/arrow.jpg '/> */}
    <div className="mt-20 font-semibold font-mono ">
    {props.menuItems.map((element,index)=><div key={index} className="flex gap-3 items-center  md:ml-[50px] ml-[110px] break-all ">
