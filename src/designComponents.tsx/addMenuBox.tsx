...
export default function AddMenuBox(props: { menuData: string[] }) {
  ...
  return (
    <div className="w-[500px] h-[420px] bg-blue-300 rounded-lg pt-5 justify-center items-center">
     ...
     { isSearchToBeShown&& itemEnteredInSearchBar.length>0 &&<div className=' left-0 right-0  m-auto absolute'> <SearchMenu itemtoSearch={itemEnteredInSearchBar.trim().replace(' ','').toLowerCase()} setSelectedItem={(elem)=>{setItemEnteredInSearchBar(elem);setIsSearchBarToBeShown(false)}}/></div>}
